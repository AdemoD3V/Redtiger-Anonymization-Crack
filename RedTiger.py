...
github = "dsc.gg/syverse"
telegram = "dsc.gg/syverse"
by = "Loxy"
version = "1.1"
ID = "2"

title = f"RedTiger v{version} - Anonymization Software cracked by Ademo | fix by Ademo "
...
def Software():
    ...
    def display_home():
        ...
        key_text = ctk.CTkLabel(container_frame, text=f"CRACKED BY Ademo", font=ctk.CTkFont(family="Helvetica", size=13), image=key_image, compound="left", text_color="white")
        key_text.grid(row=3, column=0, pady=(10, 4), padx=(0, 20), sticky="we") 

        time_text = ctk.CTkLabel(container_frame, text=f"  End: NEVER MY NIGGA", font=ctk.CTkFont(family="Helvetica", size=13), image=time_image, compound="left", text_color="white")
